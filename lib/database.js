...
function get(point) {
	if (point && typeof(point) === 'string') {
		var tree = point.split(goblin.config.pointerSymbol),
			parent = goblin.db;
...
function set(data, point, silent) {
	console.log('prueba punto paraaaaaaaaa ' + point)
	console.log('prueba data paraaaaaaaaa ' + data)
	console.log('prueba silent paraaaaaaaaa ' + silent) 
	console.log('llegaraaaaaaa ' + point)
